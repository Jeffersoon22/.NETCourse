...
namespace tutorial_1
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IUserClaimsPrincipalFactory<IdentityUser<int>>, UserClaimsPrincipalFactory<IdentityUser<int>>>();

            services.AddIdentity<IdentityUser<int>, IdentityRole<int>>(config =>
            {
                config.Password.RequiredLength = 5;
            })
                .AddEntityFrameworkStores<AppDbContext>() // where to save
            ...
            services.AddAuthentication()
                ...
                {
                    IConfigurationSection googleOAuth =
